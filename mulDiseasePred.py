# -*- coding: utf-8 -*-
"""
Created on Sun Jan 26 00:11:57 2025
...
with st.sidebar:
    selected = option_menu(
        ...
        default_index=1 #Default index shows the which page will open ,i.e,either diabetes or heart disease or parkinsons
    )
...
if selected == 'Diabetes Prediction':
    ...
    # code for Prediction
    diab_diagnosis = '' #stores the end result i.e a person is diabetic or non diabetic
    color =''
    # creating a button for Prediction
    if st.button('Diabetes Test Result'):
        diab_prediction = diabetes_model.predict([[Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age]])
        #on the above ,all the inputs are given to the model and it predict whether the person is diabetic or not
        if (diab_prediction[0] == 1): #diab_prediction[0] ,it means if the element in diab_prediction ==1
